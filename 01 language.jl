...
# ╔═╡ f7c6a55e-cd2c-4553-966b-2c7c37418ae1
eval(:id)
...
# ╔═╡ d80a4e35-bda3-4127-9b31-50e7ebc0f20b
@doc sin
...
# ╔═╡ d3cfb888-d1e3-4a38-a90d-d509036668a6
md"""
# 典型数据类型
...
# ╔═╡ ceeea49f-2b51-4ec1-8bc4-c5277c655d82
D['c']
...
# ╔═╡ a3103ffa-85e6-4231-981e-1e919325135b
range(1,10,3)

# ╔═╡ 9a4f7ab0-116a-4bf6-a613-046748b1e771
range(1,10, length=2 )

# ╔═╡ 59249e13-74d3-4d2c-913b-bc0e107ded6b
3 in 1:2:10

# ╔═╡ 20ca8b8e-8064-4f2a-b137-51b08d6015eb
md"""
...
# ╔═╡ 860c1b1e-6933-4bad-81b9-0c837564500e
md"""
...
md"""
## 向量
向量在数据分析中是非常常见的。 跟元组类似，向量也是一列数据。只不过， 向量中的元素是同一种类型。
### 向量的构造
...
# ╔═╡ 49536a1d-1ac8-4d65-a60b-62e6137397eb
...
# ╔═╡ 8ed521c0-4dfe-4762-a47c-5d4ea3a2838c

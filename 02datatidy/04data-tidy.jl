...
using CSV,DataFrames,PlutoUI,CategoricalArrays,MultivariateStats
...
# ╔═╡ e62a2e41-b131-4b0c-b497-05713943f2b0
md"""
## 连续值离散化
...
# ╔═╡ da8b641f-0705-413c-94fc-167715e0c4dd
 age = cut(train.age, 3)

# ╔═╡ a58ac73b-d4b2-4865-bb01-7108499cdd28
levels(age)
...
# ╔═╡ 3724b4b1-4c15-4c20-a269-fa62c69bf4bc
age2 = cut(train.age, [0,30,50,100])
...
# ╔═╡ 161e63a7-5064-42a0-bf2e-81c024bd203d
 cut(train.age, 3)

# ╔═╡ 12badeae-ddfb-45d4-bf40-ef009ac2f996
age3 = cut(train.age, [0,30,50,100], labels=["青","中","老"])
...
# ╔═╡ c32e8854-ef2b-416b-aec9-40ac9e98e722
unique(train.policy_state)

# ╔═╡ fe413202-37e2-4720-9a28-d77c146140a3
recode(train.policy_state, "A"=>1, "B"=>2,"C"=>3)
...
# ╔═╡ d1a7f231-cd83-4140-aa2e-58d75091dc23
md"""
## 数据的规范化
...
# ╔═╡ c27859a6-9ea0-4c87-ac7a-eb76bc32ab88
principalvars(M)
...
manifest_format = "2.0"
project_hash = "4d5e784afc56118de8fce73363a1e67cfa96c9b2"
